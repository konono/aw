...
func TestPathDerivation(t *testing.T) {
	...
	tests := []struct {
		...
		{"NixProfile", c.NixProfile(), "/home/dev/.nix-profile"},
		{"NixProfileBin", c.NixProfileBin(), "/home/dev/.nix-profile/bin"},
		{"NixProfileSh", c.NixProfileSh(), "/home/dev/.nix-profile/etc/profile.d/nix.sh"},
		{"NixStateProfiles", c.NixStateProfiles(), "/home/dev/.local/state/nix/profiles/profile"},
